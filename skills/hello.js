...
bot.reply(message, 'Hi there!');
    ...
    // Validate user input: what_is_suicide_assessment
    controller.studio.validate('hello', function(convo, next) {

    bot.reply(message, ' Hi there! Welcome to suicide screening bot!')

        var value = convo.extractResponse('hello');
        ...
        console.log('VALIDATE: hello VARIABLE: hello');
    ...
    // Before the how are you? thread starts, run this:
    controller.studio.beforeThread('hello','how are you?', function(convo, next) {

        /// do something fun and useful
        // convo.setVar('name','value');

        console.log('In the script *hello*, about to start the thread *how are you?*');
